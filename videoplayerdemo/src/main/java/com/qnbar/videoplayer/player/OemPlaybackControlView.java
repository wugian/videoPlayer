 ...
 * @author wugian
 */
public class OemPlaybackControlView extends FrameLayout {
    ...
    public OemPlaybackControlView(Context context) {
        this(context, null);
    }

    public OemPlaybackControlView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OemPlaybackControlView(Context context, AttributeSet attrs, int defStyleAttr) {
