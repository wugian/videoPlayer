 ...
 */
package com.qnbar.videoplayer.player;
...
import com.qnbar.videoplayer.R;
 ...
 */
@TargetApi(16)
public final class OemExoPlayerView extends FrameLayout {
    ...
    private final OemPlaybackControlView controller;
    ...
    public OemExoPlayerView(Context context) {
        this(context, null);
    }

    public OemExoPlayerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OemExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int controllerShowTimeoutMs = OemPlaybackControlView.DEFAULT_SHOW_TIMEOUT_MS;
        ...
        OemPlaybackControlView customController = findViewById(R.id.exo_controller);
        ...
        if (customController != null) {
            ...
            this.controller = new OemPlaybackControlView(context, null, 0, attrs);
    ...
    public static void switchTargetView(@NonNull SimpleExoPlayer player,
                                        @Nullable OemExoPlayerView oldPlayerView, @Nullable OemExoPlayerView newPlayerView) {
     ...
     * use {@link #switchTargetView(SimpleExoPlayer, OemExoPlayerView, OemExoPlayerView)} rather
    ...
    /**
     * Set the {@link OemPlaybackControlView.VisibilityListener}.
     *
     * @param listener The listener to be notified about visibility changes.
     */
    public void setControllerVisibilityListener(OemPlaybackControlView.VisibilityListener listener) {
        Assertions.checkState(controller != null);
